...
this script now is only for weekdays. 
@author: lu000012
"""
  ...
  def dynamic(self):       
   ...
   #start modeling 
    ...
    if self.timestep == nrOfTimeSteps:
       ...
       self.report(self.startmap,"commwd")
       self.startmap_home = self.startmap_home/nrOfTimeSteps/3600
       self.report(self.startmap_home,"homewd")
